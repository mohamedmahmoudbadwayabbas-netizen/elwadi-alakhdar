...
function createSupabaseFetch(supabaseKey: string): typeof fetch {
  return async (input, init) => {
    ...
    try {
      ...
      // Never turn network failures into fake successful responses. Supabase callers
      // need the real failure so the UI can show an accurate state and retries remain possible.
