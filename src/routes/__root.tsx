...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "تسوّق البقالة واللحوم والدواجن والعطارة من الوادي الأخضر بأسعار مناسبة مع توصيل سريع لباب بيتك." },
      { property: "og:description", content: "تسوّق البقالة واللحوم والدواجن والعطارة من الوادي الأخضر بأسعار مناسبة مع توصيل سريع لباب بيتك." },
      { name: "twitter:description", content: "تسوّق البقالة واللحوم والدواجن والعطارة من الوادي الأخضر بأسعار مناسبة مع توصيل سريع لباب بيتك." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/7FGpG204P8ZoMaDVUrQDzFmMxBS2/social-images/social-1785331350061-1785331017982.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/7FGpG204P8ZoMaDVUrQDzFmMxBS2/social-images/social-1785331350061-1785331017982.webp" },
    ],
    links: [
